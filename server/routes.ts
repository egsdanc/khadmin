...
export function registerRoutes(app: Express): Server {
  ...
  // Sipay callback route - must be before auth middleware and outside /api/sipay
  // This allows Sipay to call the callback without authentication
  app.use("/api/sipay-callback", callbackRouter);
